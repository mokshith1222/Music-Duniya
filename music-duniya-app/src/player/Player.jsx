...
export default function Player() {
  ...
  // The core playback logic is now handled in PlayerContext.
  // This component just dispatches actions and renders the UI.
            ...
            >
              ...
              <div className="flex min-w-0 flex-1 items-center gap-3">
                <motion.img 
                  ...
                  src={currentTrack?.cover || coverFallback(currentTrack.id)} 
              ...
              <div className="flex items-center gap-2">
                <button onClick={(e) => { e.stopPropagation(); setShowLyrics(true); }} className="p-2 text-slate-300 hover:text-cyan-300 transition-colors">
                  <Mic2 size={18} />
                </button>
                ...
                <button onClick={(e) => { e.stopPropagation(); playNext(); }} className="p-2 text-slate-300 hover:text-white transition-colors">
                  <SkipForward size={18} />
                </button>
              </div>
            </motion.div>
